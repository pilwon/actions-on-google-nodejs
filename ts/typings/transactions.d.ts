/**
 * A collection of Transaction related constants, utility functions, and builders.
 */
...
export interface ReceiptInfo {
  ...
  // Used when the order has been received by the integrator.
...
export interface TransactionDecision {
  ...
  order: {
    ...
    // User visible order ID set in proposed
    ...
    paymentInfo: {
      // Returned for all types of payment methods
